...
export function Configuration() {
  ...
  const handleInvoiceBankChange = (
    field: keyof typeof emptyInvoiceBank,
    value: string,
  ) => {
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Existing sales and products keep their saved platform names
                    even if you remove a marketplace from this list. Add a name
                    here before using it on new product listings.
                  </p>
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleInvoiceBankChange("invoiceTerms", e.target.value)
                    }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
                  <div className="lg:col-span-4">
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvoiceBankChange("bankName", e.target.value)
                      }
                  ...
                  <div className="lg:col-span-4">
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvoiceBankChange("bankIban", e.target.value)
                      }
                      placeholder="AE00…"
                    />
                  </div>
                  ...
                  <div className="lg:col-span-4">
                    <Input
                      ...
                      onChange={(e) =>
                        handleInvoiceBankChange("bankSwift", e.target.value)
                      }
                    />
                  </div>
                </div>
