...
export function Subscription() {
  ...
  const whatsApp =
    SUPPORT_WHATSAPP.find(
      (c) => c.region === (company?.country === "IN" ? "India" : "UAE"),
    ) ?? SUPPORT_WHATSAPP[0];
      ...
      <div className="space-y-6">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 sm:p-6 shadow-sm">
            ...
            <dl className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <dd className="text-gray-900 dark:text-white font-medium">
                  {org?.companyQuota ?? 1} compan
                  {org?.companyQuota === 1 ? "y" : "ies"}
                </dd>
              </div>
              <div>
                <dt className="text-xs text-gray-500 dark:text-gray-400">
          ...
          <article className="max-w-lg rounded-xl border border-indigo-500/30 dark:border-indigo-400/30 ring-1 ring-indigo-500/10 bg-indigo-50/40 dark:bg-indigo-950/20 p-5 sm:p-6">
            ...
            <div className="mb-5">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 mb-3">
                Annual plans with 12 months access — we&apos;ll share details
            ...
            <ul className="space-y-2">
              {plan.features.map((feature) => (
                ...
                >
                  <Check
                    className="w-4 h-4 shrink-0 text-indigo-500 mt-0.5"
                    aria-hidden
                  />
                  <span>{feature}</span>
                </li>
        ...
        <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 sm:p-6 shadow-sm">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-4">
            Online checkout is coming soon. To subscribe after trial or renew
            after expiry, contact us on WhatsApp with your organization name and
