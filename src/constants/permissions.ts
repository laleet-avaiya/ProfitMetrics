...
export const MODULE_DEFINITIONS: {
  ...
  { id: AppModule.SALES, label: 'Sales', description: 'Marketplace & offline sales', group: 'sales' },
  { id: AppModule.INVOICES, label: 'Invoices', description: 'Customer invoices', group: 'sales' },
